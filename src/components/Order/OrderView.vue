    ...
    <el-card>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column label="操作">
          <template v-slot="scope">
            <el-button type="primary" icon="Edit" size="default" @click="showBox(scope.row)"></el-button>
            <el-button type="success" icon="LocationInformation" size="default"
      ...
      <el-pagination v-model:current-page="queryInfo.pagenum" v-model:page-size="queryInfo.pagesize"
        :page-sizes="[1, 2, 5, 10]" :background="background" layout="total, sizes, prev, pager, next, jumper"
    ...
    <el-dialog title="修改地址" v-model="addressVisible" width="50%" @close="addressDialogClosed">
      ...
      <el-form :model="addressForm" :rules="addressFormRules" ref="addressFormRef" label-width="120px">
        <el-form-item label="省市区/县" prop="address1">
          ...
          <el-cascader v-model="addressForm.address1" :options="cityData" :props="cascaderProps" placeholder="请选择省市区/县"
            clearable>
          </el-cascader>
        </el-form-item>
